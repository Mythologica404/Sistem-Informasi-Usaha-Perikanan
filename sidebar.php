...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            <li class="menu-header">Menu</li>
            <li><a class="nav-link" href="?page=home"><i class="fas fa-home"></i> <span>Dashboard</span></a></li>
            <li class="nav-item dropdown">
            ...
            <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-receipt"></i> <span>Transaksi</span></a>
                <ul class="dropdown-menu">
