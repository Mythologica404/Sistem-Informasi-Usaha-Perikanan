...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Tambah Data Status Transaksi 02</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="#">Tambah Data</a></div>
                <div class="breadcrumb-item">Status Transaksi 02</div>
            </div>
        </div>

        <div class="section-body">
            <h2 class="section-title">Status Transaksi 02</h2>
            <p class="section-lead">Berikut adalah form untuk menambahkan data ke tabel Status Transaksi 02.</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = mysqli_query($con, "INSERT INTO tb_trx_status_02 (Id, Tanggal, Id_tb_trx_01, Status_awal, Id_kategori_05, Keterangan) VALUES (NULL, '$Tanggal', '$Id_tb_trx_01', '$Status_awal', '$Id_kategori_05', '$Keterangan')") or die(mysqli_error($con));
                    ...
                    ?>
                    <form action="index.php?page=status_transaksi_02" method="post" enctype="multipart/form-data">
