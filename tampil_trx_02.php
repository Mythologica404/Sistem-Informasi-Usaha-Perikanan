...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Lihat Data Transaksi Non Penjualan</h1>
        ...
        <div class="section-body">
            ...
            <p class="section-lead">Berikut adalah tabel Transaksi Non Penjualan</p>

            <div class="card">
                <div class="card-header">
                    <h4 id="nama-table">Tabel Transaksi Non Penjualan</h4>
                </div>
